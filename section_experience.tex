...
\begin{experiences}
	...
	{Nov 2023}	{
		\begin{itemize}
			\item Optimised the calibration process for our AFE by 20x, taking calibration time from 12+ Hrs down to 40 minutes. This removed a major bottleneck from the production team's process and increased their output capacity, leading to their ability to deliver far more units than before.
